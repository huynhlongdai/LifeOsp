...
> | `feat/ui-design-system-v1` (Viktor, 14/09, 100 files) | AI Coach chat, "Điểm cuộc sống", Admin panel, onboarding, demo dataset, custom AI provider | **do not merge as a whole** — contradicts Meeting #019 / `FIGMA_MAKE_RECONCILIATION_V1`; product owner wants to **cherry-pick Admin panel and first-run onboarding later**, re-expressed in design system V1 |
>
