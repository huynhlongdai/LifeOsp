...
export type AppRoute = (typeof APP_ROUTES)[number] | typeof CLARITY_ROUTE | typeof INBOX_ROUTE | typeof INCUBATOR_ROUTE | typeof COACH_ROUTE;
export type AppRouteKey = AppRoute["key"];

const ALL_ROUTES: readonly AppRoute[] = [...APP_ROUTES, CLARITY_ROUTE, INBOX_ROUTE, INCUBATOR_ROUTE, COACH_ROUTE];
